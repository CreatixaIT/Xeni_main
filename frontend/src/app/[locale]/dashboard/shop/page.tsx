...
export default function ShopPage() {
    ...
    try {
      ...
      if (shopRes.status === "fulfilled") {
        ...
        setForm({
          ...
          store_theme: s.store_theme || "modern",
          storefront_published: s.storefront_published ?? false,
        });
      } else {
        setIsNew(true);
      }
  ...
  return (
    <div className="p-6 lg:p-8 max-w-3xl">
      <div className="mb-8">
        <h1
          className="text-2xl font-heading font-bold flex items-center gap-3"
        ...
        <p className="mt-1" style={{ color: "var(--text-muted)" }}>
          {isNew
            ? "Create your shop to start selling on Messenger."
      ...
      <div className="space-y-6">
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, owner_mobile: e.target.value })
                }
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                className="input-field"
                value={form.courier_preference}
                onChange={(e) =>
                  setForm({ ...form, courier_preference: e.target.value })
                }
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label
                ...
                style={{ color: "var(--text-secondary)" }}
              >
                Delivery Charge (Inside District)
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  value={form.delivery_charge_inside}
                  onChange={(e) =>
                    setForm({
                      ...form,
                      delivery_charge_inside: Number(e.target.value),
                    })
                  }
                />
              </div>
            ...
            <div>
              <label
                ...
                style={{ color: "var(--text-secondary)" }}
              >
                Delivery Charge (Outside District)
              </label>
              <div className="relative">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400">
                  ৳
                ...
                <input
                  ...
                  onChange={(e) =>
                    setForm({
                      ...form,
                      delivery_charge_outside: Number(e.target.value),
                    })
                  }
                />
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                className="input-field"
                placeholder="01XXXXXXXXX"
                value={form.bkash_merchant_number}
                onChange={(e) =>
                  setForm({ ...form, bkash_merchant_number: e.target.value })
                }
              />
            </div>
            <div>
              ...
              <input
                className="input-field"
                placeholder="01XXXXXXXXX"
                value={form.nagad_merchant_number}
                onChange={(e) =>
                  setForm({ ...form, nagad_merchant_number: e.target.value })
                }
              />
            </div>
          </div>
            ...
            <label className="flex items-center justify-between cursor-pointer">
              <div>
                <p
                  ...
                  style={{ color: "var(--text-primary)" }}
                >
                  Auto-Reply (AI Conversation)
                </p>
                <p className="text-xs" style={{ color: "var(--text-muted)" }}>
                  Let AI respond to Messenger messages automatically
                </p>
              </div>
              <div
                className={`w-11 h-6 rounded-full relative transition-colors ${form.auto_reply_enabled ? "bg-primary" : "bg-gray-600"}`}
                onClick={() =>
                  setForm({
                    ...form,
              ...
              >
                <div
                  className={`absolute top-0.5 left-0.5 w-5 h-5 rounded-full bg-white transition-transform ${form.auto_reply_enabled ? "translate-x-5" : ""}`}
                />
              </div>
            </label>
            <label className="flex items-center justify-between cursor-pointer">
              <div>
                ...
                <p className="text-xs" style={{ color: "var(--text-muted)" }}>
                  Automatically verify payments and book couriers
                </p>
              </div>
              <div
                className={`w-11 h-6 rounded-full relative transition-colors ${form.auto_order_enabled ? "bg-primary" : "bg-gray-600"}`}
                onClick={() =>
                  setForm({
                    ...form,
                    auto_order_enabled: !form.auto_order_enabled,
                  })
                }
              >
                <div
                  className={`absolute top-0.5 left-0.5 w-5 h-5 rounded-full bg-white transition-transform ${form.auto_order_enabled ? "translate-x-5" : ""}`}
                />
              </div>
            </label>
          </div>

          {/* ── E-Pic Marketplace Storefront ── */}
          <div
            className="space-y-4 pt-2 border-t"
            style={{ borderColor: "var(--border-color)" }}
          >
            ...
            <label className="flex items-center justify-between cursor-pointer">
              <div>
                ...
                <p className="text-xs" style={{ color: "var(--text-muted)" }}>
                  Make your store visible on E-Pic marketplace
                </p>
              </div>
              <div
                className={`w-11 h-6 rounded-full relative transition-colors ${form.storefront_published ? "bg-primary" : "bg-gray-600"}`}
                onClick={() =>
                  setForm({
                    ...form,
              ...
              >
                <div
                  className={`absolute top-0.5 left-0.5 w-5 h-5 rounded-full bg-white transition-transform ${form.storefront_published ? "translate-x-5" : ""}`}
                />
              </div>
            </label>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setForm({ ...form, store_theme: e.target.value })
                }
              >
              ...
              <p
                ...
                style={{ color: "var(--text-muted)" }}
              >
                Choose how your store appears on E-Pic marketplace
              </p>
            </div>

            {/* Public Store URL */}
            {shop?.shop_slug && form.storefront_published && (
              <div className="p-3 rounded-lg bg-primary/10 border border-primary/20">
                ...
                <p
                  ...
                  style={{ color: "var(--text-primary)" }}
                >
                  https://e-pic.co/store/{shop.shop_slug}
                </p>
              </div>
            )}
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-dark-300 mb-4">
                  Train your Xeni bot visually. Set custom rules for tone,
                  delivery, return policy, and behavior alongside our
                  platform-wide master constraints.
                </p>
                <Link
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p
                ...
                style={{ color: "var(--text-muted)" }}
              >
                Configure how order payments are verified by the AI.
              </p>
            </div>
            <select
              ...
              onChange={(e) =>
                setForm({ ...form, payment_verification_mode: e.target.value })
              }
            >
          ...
          {form.payment_verification_mode === "manual" ? (
            <div className="p-4 rounded-xl bg-orange-500/10 border border-orange-500/20 text-orange-600 dark:text-orange-400 text-sm flex gap-3">
              ...
              <p>
                আপনি <strong>ম্যানুয়াল রিভিউ</strong> সিলেক্ট করেছেন। কাস্টমার
                পেমেন্ট ট্রানজেকশন আইডি বা স্ক্রিনশট দিলে সেটা আপনার ড্যাশবোর্ডে{" "}
                <strong>Manual Review</strong> ট্যাবে আসবে এবং আপনি
                হোয়াটসঅ্যাপে নোটিফিকেশন পাবেন। আপনাকে নিজে চেক করে Approve করতে
                হবে।
              </p>
            </div>
          ) : (
            <div className="space-y-6 animate-in slide-in-from-top-2">
              <div className="p-4 rounded-xl bg-primary/10 border border-primary/20 text-primary text-sm flex gap-3">
                ...
                <p>
                  আপনি <strong>অটো ভেরিফিকেশন</strong> সিলেক্ট করেছেন। দয়া করে
                  নিচের API Key গুলো সঠিকভাবে দিন। কাস্টমার টাকা পাঠালে AI নিজে
                  নিজে চেক করে অর্ডার কনফার্ম করে দিবে।
                </p>
              </div>
              ...
              >
                <h3 className="font-semibold mb-3 flex items-center gap-2 text-pink-600 dark:text-pink-400">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setForm({ ...form, bkash_app_key: e.target.value })
                      }
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setForm({ ...form, bkash_app_secret: e.target.value })
                      }
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      value={form.nagad_merchant_id}
                      onChange={(e) =>
                        setForm({ ...form, nagad_merchant_id: e.target.value })
                      }
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      value={form.nagad_merchant_key}
                      onChange={(e) =>
                        setForm({ ...form, nagad_merchant_key: e.target.value })
                      }
                    />
                  </div>
                </div>
        ...
        >
          ...
          <p className="text-sm mb-6" style={{ color: "var(--text-muted)" }}>
            Configure your custom connection keys if you want the AI to handle
            courier bookings under your own corporate account.
          </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    value={form.integrations.pathao_client_id}
                    onChange={(e) =>
                      setForm({
                        ...form,
                        integrations: {
                          ...form.integrations,
                          pathao_client_id: e.target.value,
                        },
                      })
                    }
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    value={form.integrations.pathao_client_secret}
                    onChange={(e) =>
                      setForm({
                        ...form,
                        integrations: {
                          ...form.integrations,
                          pathao_client_secret: e.target.value,
                        },
                      })
                    }
                  />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    className="input-field"
                    placeholder="API Key"
                    value={form.integrations.steadfast_api_key}
                    onChange={(e) =>
                      setForm({
                        ...form,
                        integrations: {
                          ...form.integrations,
                          steadfast_api_key: e.target.value,
                        },
                      })
                    }
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    value={form.integrations.steadfast_secret_key}
                    onChange={(e) =>
                      setForm({
                        ...form,
                        integrations: {
                          ...form.integrations,
                          steadfast_secret_key: e.target.value,
                        },
                      })
                    }
                  />
